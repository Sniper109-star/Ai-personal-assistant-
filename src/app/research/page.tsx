...
export default function ResearchPage() {
  ...
  function addSource() {
    ...
    setSources([
      ...sources,
      { id: `${Date.now()}`, title: sourceTitle.trim(), content: sourceContent.trim() },
    ]);
    setSourceTitle("");
    setSourceContent("");
  }
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-16">
      <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">Research Autonomy</h1>
      <p className="mt-2 text-sm text-neutral-400 sm:text-base">
        Gather, compare, analyze, and synthesize information across sources to produce structured, decision-ready insight.
      </p>

      <form onSubmit={runResearch} className="mt-6 space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Should I use React or Vue?"
            className="mt-1.5 block w-full rounded-xl border border-neutral-700 bg-neutral-800 px-4 py-3 text-sm text-white placeholder-neutral-500 focus:border-white focus:outline-none focus:ring-1 focus:ring-white"
            required
          />
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-4">
          ...
          <div className="mt-3 grid gap-3">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-xl border border-neutral-700 bg-neutral-800 px-3 py-2.5 text-sm text-white placeholder-neutral-500 focus:border-white focus:outline-none focus:ring-1 focus:ring-white"
              />
            </div>
            <div>
          ...
          <button
            ...
            className="mt-3 w-full rounded-xl border border-neutral-700 bg-neutral-800 px-4 py-2.5 text-sm font-medium text-white transition hover:border-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 active:scale-[0.98]"
          >
            Add Source
          </button>
          ...
          {sources.length > 0 && (
            <ul className="mt-4 space-y-2">
              {sources.map((source) => (
                <li key={source.id} className="flex items-start justify-between gap-3 rounded-xl border border-neutral-800 bg-neutral-800/50 p-3">
                  ...
                  <button
                    ...
                    className="shrink-0 text-xs text-neutral-500 transition hover:text-red-400 active:scale-[0.95]"
                  >
                    Remove
                  </button>
                </li>
        ...
        <div className="mt-8 space-y-6">
          {result.sources && result.sources.length > 0 && (
            <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6">
              <h2 className="text-base font-semibold text-white sm:text-lg">Web Results</h2>
          ...
          <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6">
            <h2 className="text-base font-semibold text-white sm:text-lg">Summary</h2>
            <p className="mt-2 text-sm leading-relaxed text-neutral-300">{result.summary}</p>
          </section>

          <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6">
            <h2 className="text-base font-semibold text-white sm:text-lg">Key Insights</h2>
          ...
          <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6">
            <h2 className="text-base font-semibold text-white sm:text-lg">Comparison</h2>
            <ul className="mt-3 space-y-2">
          ...
          <section className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 sm:p-6">
            <h2 className="text-base font-semibold text-white sm:text-lg">Conclusion</h2>
